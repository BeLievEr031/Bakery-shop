    ...
    return (
        <div className='flex justify-center pt-8'>
            <div className='flex items-center '>
                <div className='w-[250px] h-[5px] bg-red-800 relative max-sm:w-[70px]'>
                    <div
                ...
                <h1 className='text-[40px] px-4 max-sm:px-2 uppercase max-sm:text-[20px]'>{text}</h1>
                <div className='w-[250px] h-[5px] bg-red-800 relative max-sm:w-[78px]'>
